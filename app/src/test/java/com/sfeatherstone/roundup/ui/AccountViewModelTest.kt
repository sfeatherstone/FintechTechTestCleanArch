package com.sfeatherstone.roundup.ui
...
import com.sfeatherstone.roundup.model.AccountState
import com.sfeatherstone.roundup.useCase.GetAccount
...
class AccountViewModelTest{
    ...
    fun `when useCase returns valid data then livedata shows correct states`() {
        ...
        val mainViewModel = AccountViewModel(
            getAccount,
            mock(),
            mock(),
            mock(),
        ...
        runBlocking {
            ...
            assertEquals(
                Account(
                    uuid1,
                    uuid2
                ), (mainViewModel.account.value as AccountState.Success).data)
        }
